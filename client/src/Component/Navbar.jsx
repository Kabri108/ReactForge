...
export default function Navbar() {
  ...
  return (
    <nav className="fixed z-50 w-full top-0 bg-white border-b-2 border-gray-800 dark:bg-gray-800 dark:border-gray-700">
      <div className="px-3 py-3 lg:px-5 lg:pl-3">
        <div className="flex justify-between items-center px-5">
          {/* Logo */}
          <Link to="/" className="font-bold text-rose-500 text-3xl">
            React Forge
          </Link>
